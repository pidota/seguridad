...
final class ReferralController extends SendaController
{
    ...
    private function formData(array $record, array $attention, array $person, bool $isEdit, string $flow = ''): array
    {
        ...
        return [
            ...
            'familyRelationships' => AssistedReferralCatalog::familyApplicantRelationships(),
            'institutionalRelationships' => AssistedReferralCatalog::institutionalApplicantRelationships(),
