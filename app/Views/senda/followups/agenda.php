...
<form method="get" action="<?= e(url('/senda/follow-ups')) ?>" class="page-card senda-filters mb-3">
    ...
    <div class="senda-filters__actions">
        ...
        <?php if ($hasFilters): ?>
            <a class="btn btn-outline-navy" href="<?= e(url('/senda/follow-ups')) ?>">Volver a búsqueda por RUT</a>
        <?php endif; ?>
    </div>
</form>
...
<div class="page-card">
    <div class="page-toolbar mb-3">
        <h3 class="page-card__title mb-0">Agenda de seguimientos</h3>
        <p class="text-secondary mb-0"><?= (int) ($total ?? 0) ?> registros</p>
    </div>
    <div class="table-responsive">
        <table class="data-table">
            ...
            <tbody>
                <?php if (($followups ?? []) === []): ?>
                    <tr>
                        <td colspan="9" class="text-secondary">No hay seguimientos para mostrar.</td>
                    </tr>
                <?php else: ?>
