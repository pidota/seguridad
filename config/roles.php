...
return [
    ...
    'administrador_seguridad' => [
        ...
        'women.statistics.view', 'women.statistics.export',
        'meetings.access', 'meetings.view', 'meetings.view_all', 'meetings.sign', 'meetings.view_pending_signatures', 'meetings.reopen', 'meetings.cancel', 'meetings.delete',
        'guards.access', 'guards.shifts.view', 'guards.shifts.create', 'guards.shifts.update', 'guards.shifts.close', 'guards.shifts.view_all',
        'guards.log.view', 'guards.log.create', 'guards.log.link_cctv',
    ],
    ...
    'senda' => [
        ...
        'meetings.access', 'meetings.view', 'meetings.create', 'meetings.edit', 'meetings.sign', 'meetings.view_pending_signatures', 'meetings.signature.manage', 'meetings.reopen', 'meetings.delete',
    ],
    ...
    'consulta' => [
        ...
        'cctv.recordings.view',
        'cctv.reports.view',
        'women.access', 'women.dashboard.view', 'women.cases.view', 'women.statistics.view', 'women.statistics.export',
        'guards.access', 'guards.shifts.view', 'guards.shifts.view_all', 'guards.log.view',
    ],
];
