...
return [
    ...
    'map_default_latitude' => (float) env('CCTV_MAP_DEFAULT_LAT', -34.7333),
    'map_default_longitude' => (float) env('CCTV_MAP_DEFAULT_LNG', -71.2833),
    'map_default_zoom' => (int) env('CCTV_MAP_DEFAULT_ZOOM', 14),
];
